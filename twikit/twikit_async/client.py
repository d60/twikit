...
class Client:
    ...
    async def upload_media(self, source: str | bytes, index: int) -> int:
        ...
        >>> media_id_1 = await client.upload_media('media1.jpg', index=0)
        >>> media_id_2 = await client.upload_media('media2.jpg', index=1)
        >>> media_id_3 = await client.upload_media('media3.jpg', index=2)
        """
